...
<div class="controls">	 
	<input type="text" readonly="readonly" name="codCompras" value="${comp.codCompras}" /> <br />
</div>
</div>
...
<div class="controls">	 
	<input type="text" name="dsData" value="${comp.dsData}" /> <br />
</div>
</div>
...
<div class="controls">	 
	<input type="text" name="codFuncionario" value="${comp.funcionario.codFuncionario}" /> <br />
</div>
</div>
